/*
 * File: BackingMapEntryInsertedEvent.java
 * 
...
/**
 * <p>An implementation of {@link EntryInsertedEvent} with {@link BackingMapEntryEvent} support.</p>
 * 
 * @author Brian Oliver
 */
public class BackingMapEntryInsertedEvent extends AbstractBackingMapEntryEvent implements EntryInsertedEvent
{
     ...
     */
    public BackingMapEntryInsertedEvent(BackingMapManagerContext backingMapManagerContext,
                                        String cacheName,
                                        Entry<?, ?> entry)
    {
