 ...
 */
package com.oracle.coherence.system.network;
...
public class AvailablePortIterator implements Iterator<Integer>
{
    ...
    {
        this(InetAddress.getByName("127.0.0.1"), MINIMUM_PORT, MAXIMUM_PORT);
    }
    ...
    public AvailablePortIterator(int portRangeStart,
                                 int portRangeEnd) throws UnknownHostException
    {
        this(InetAddress.getByName("127.0.0.1"), portRangeStart, portRangeEnd);
    }
    ...
    {
        this(InetAddress.getByName("127.0.0.1"), portRangeStart, MAXIMUM_PORT);
    }
    ...
    public void remove()
    {
        throw new UnsupportedOperationException(
            "It's illegal to attempt to remove() a port from an AvailablePortIterator");
    }
}
